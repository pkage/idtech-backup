...
-(id)initWithSize:(CGSize)size {
    if (self = [super initWithSize:size]) {
		...
		SKEmitterNode *node = [NSKeyedUnarchiver unarchiveObjectWithFile:[[NSBundle mainBundle] pathForResource:@"FireParticle" ofType:@"sks"]];
        node.position = CGPointZero;
		[self.playerSprite addChild:node];
